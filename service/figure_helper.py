    ...
    def __init__(self, **opts_dict):
        ...
        self.figure_dict = {
                ...
                'dash_capstyle':"round",
                 ...
                 "sheet_title": None, # for excel saving the name of the sheet, if not given, it takes plot_title
                 ...
                 "azim": None,
                 "label": None,
                 "sheet_label": None,  # for excel saving the name of the sheet, if not given, it takes label
                 "xticks": None,
                 "yticks": None,
                 "zticks": None,
                 "xl": None,
