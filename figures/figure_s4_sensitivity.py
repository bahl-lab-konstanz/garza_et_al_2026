...
for i_p, p in enumerate(ConfigurationDDM.parameter_list):
    ...
    print(fr"{p['label_show']} | significant for a perturbation of +{int(x_positive_significant * 100)}%")
    ...
    print(fr"{p['label_show']} | significant for a perturbation of {int(x_negative_significant * 100)}%")
